...
export const metadata: Metadata = {
  title: "Agencia de Google Ads en Argentina | JT Ads Performance",
  description:
    "Especialistas en Google Ads para empresas en Argentina. Tracking server-side, sin contratos largos y gestión senior. Primera sesión de diagnóstico gratis.",
  alternates: {
...
const cities = [
  { name: "Buenos Aires", note: "Hub corporativo, fintech y servicios digitales" },
  { name: "Córdoba", note: "Tech, educación y servicios B2B" },
  { name: "Rosario", note: "Agroindustria, comercio y logística" },
  { name: "Mendoza", note: "Vitivinicultura, turismo y real estate" },
  { name: "Tucumán", note: "Agroindustria y servicios regionales" },
  { name: "Mar del Plata", note: "Turismo, retail y servicios" },
];
...
const faqItems = [
  ...
  },
  {
    ...
    a: "Sí. Hemos gestionado cuentas para empresas en Buenos Aires, Córdoba y Rosario en sectores como SaaS B2B, educación online y servicios profesionales. Conocemos las particularidades del mercado local en términos de competencia y comportamiento del usuario.",
  },
  {
    q: "¿Cómo funciona el trabajo remoto con una agencia fuera de Argentina?",
    a: "Trabajamos 100% de forma remota. Las reuniones de diagnóstico y seguimiento son por videollamada con pantalla compartida. El acceso a la cuenta es en tiempo real — puedes ver todo lo que hacemos cuando quieras.",
  },
  {
      ...
      >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                >
                  Agencia de Google Ads en Argentina para empresas que necesitan resultados medibles en un mercado exigente.
                </h1>
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex gap-2 flex-wrap mb-5">
                        {["Buenos Aires", "Córdoba", "Rosario"].map((city) => (
                          <span
                            key={city}
                      ...
                      <div>
                        ...
                        >
                          <div
                            ...
                            style={{ width: "44%", backgroundColor: "#0066ff" }}
                          />
                        </div>
                      </div>
                    </div>
              ...
              {[
                {
                  ...
                  text: "Las agencias en Argentina reportan el CPL de plataforma sin conectarlo con las ventas reales del negocio.",
                },
                {
                  icon: (
                    <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  text: "En un mercado con alta volatilidad, cada peso mal invertido en ads tiene un impacto mayor en el resultado.",
                },
                {
                  icon: (
                    <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  text: "Contratos de largo plazo que no se ajustan a las condiciones cambiantes del mercado argentino.",
                },
              ].map((pain, i) => (
                <div
                  key={i}
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              <h2
                ...
                style={{ fontFamily: "Manrope, sans-serif", color: "#1c1b1b" }}
              >
                Antes de contratar una agencia en Argentina, compara lo que realmente importa.
              </h2>
            </div>
        ...
        <section className="py-24" style={{ backgroundColor: "#f6f3f2" }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2
              ...
              style={{ fontFamily: "Manrope, sans-serif", color: "#1c1b1b" }}
            >
              Operamos en los principales mercados de Argentina
            </h2>
        ...
        <section className="py-24" style={{ backgroundColor: "#fff" }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2
              ...
              style={{ fontFamily: "Manrope, sans-serif", color: "#1c1b1b" }}
            >
              Qué gestionamos en Google Ads para empresas argentinas
            </h2>
        ...
        <section className="py-24" style={{ backgroundColor: "#f6f3f2" }}>
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2
              ...
              style={{ fontFamily: "Manrope, sans-serif", color: "#1c1b1b" }}
            >
              Preguntas frecuentes — Google Ads Argentina
            </h2>
        ...
        <section className="py-20 text-center" style={{ backgroundColor: "#0066ff" }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              En Argentina, cada peso en ads cuenta el doble.
            </h2>
            <p className="text-lg mb-10" style={{ color: "rgba(255,255,255,0.85)" }}>
              Una cuenta mal optimizada en un mercado de alta inflación tiene un costo real mayor.
