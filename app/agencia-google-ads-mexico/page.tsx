...
export const metadata: Metadata = {
  title: "Agencia de Google Ads en México | JT Ads Performance",
  description:
    "Especialistas en Google Ads para empresas en México. Tracking server-side, sin contratos largos y gestión senior. Primera sesión de diagnóstico gratis.",
  alternates: {
